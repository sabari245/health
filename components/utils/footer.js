        ...
        <footer className="bg-white">
            <div className="container px-6 py-8 mx-auto">
                {/* <div className="text-center">
                    <a href="#" className="text-2xl font-bold text-gray-800 hover:text-gray-700">Brand</a>

                    <p className="max-w-md mx-auto mt-2 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
